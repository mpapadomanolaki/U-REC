...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes):
        ...
        self.R_conv_2_1 = conv_block(512, 512)
        ...
        self.R_conv_3_1 = conv_block(256,256)
        ...
        self.R_conv_4_1 = conv_block(128, 128)
    ...
    def forward(self, x):
        ...
        x1,x2,x3,x4,x5,x_mp = self.encode(x)
